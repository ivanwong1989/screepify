...
module.exports = function execBuild(creep, intent, context = {}) {
  try {
    ...
    if (typeof target.progress !== 'number') return { status: STATUS.INVALID };
