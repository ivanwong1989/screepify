const resolveEnergySource = require('task_resolve_resolveEnergySource');
const resolveEnergySink = require('task_resolve_resolveEnergySink');
...
var managerTasks = {
    ...
    getTransferTask: function(creep, mission, room) {
        ...
        if (creep.memory.taskState === 'working') {
            ...
            const target = resolveEnergySink(creep, mission, room, {
                getCachedObject: this.getCachedObject.bind(this)
            });
    ...
    getGatherTask: function(creep, room, options = {}) {
        return resolveEnergySource(creep, room, options, {
            getCachedObject: this.getCachedObject.bind(this)
        });
    }
};
