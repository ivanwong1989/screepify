    ...
    Object.defineProperty(global, 'help', {
        get: function() {
            const lines = [
                ...
                'debugvispathson      - enable remote path visual logging (haul/harvest lanes)',
                'debugvispathsoff     - disable remote path visual logging',
                ...
                'memwrite(path, value) - safe Memory write by dot path',
                'memread(path)         - read Memory value by dot path',
                'memdelete(path)       - delete one Memory key by dot path',
                'mempatch(path, patch) - deep-merge plain object patch by dot path',
